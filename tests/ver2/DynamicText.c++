...
using namespace winhelp; // also leaks windows.h
...
int main() {
    display d({width, height}, "Dynamic Text");
    ...
    while (true) {
        ...
        d.surface.blit({10, 10}, font.render("FPS: " + std::to_string(fps), {255, 255, 255}, {0, 0, 0, 0}));
